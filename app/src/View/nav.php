    ...
    <nav class="bg-white dark:bg-gray-800  shadow py-4">
        <div class="max-w-7xl mx-auto px-8">
            <div class="flex items-center justify-between h-12">
                ...
                <div class="flex">
                    <div class="flex flex-col w-3/4 mr-3">
                        <a href="/admin">
                            <button class="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-red-600 rounded-lg shadow-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-red-200">
                                Administration
                            </button>
                        </a>
                    </div>
